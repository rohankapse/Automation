...
public static String getCellData(int RowNum, int ColNum) throws Exception{
		...
		try{
			...
			//String s1 = (int) Double.parseDouble(String.valueOf(Cell)) + "";
...
// Constant variables Test Data path and Test Data file name
				...
				FileOutputStream fileOut = new FileOutputStream(Constant.Path_TestData2 + Filename);
	...
	public static void FileOut (String Filename) throws Exception {
		
		try {
			
		FileOutputStream fileOut = new FileOutputStream(Constant.Path_DownLoad + Filename);
